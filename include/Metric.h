...
struct Metric {
 ...
 public:
  ...
  void print() {
    if (predicated_label_count == 0) {
      ...
      std::cout << "Recall:\tP=" << correct_label_count << "/" << overall_label_count << "="
                << correct_label_count * 1.0 / overall_label_count
                << ", " << "Accuracy:\tP=" << correct_label_count << "/" << predicated_label_count << "="
                << correct_label_count * 1.0 / predicated_label_count
                << ", " << "Fmeasure:\t" << correct_label_count * 2.0 / (overall_label_count + predicated_label_count)
                << std::endl;
    }
  }
 ...
 public:
  bool operator==(const Metric &a1) const {
    return correct_label_count == a1.correct_label_count && overall_label_count == a1.overall_label_count
        && predicated_label_count == a1.predicated_label_count;
  }
